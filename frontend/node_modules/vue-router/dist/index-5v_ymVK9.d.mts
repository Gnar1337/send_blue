...
interface _NavigationGuardResolved {
  (this: undefined, to: RouteLocationNormalizedLoaded, from: RouteLocationNormalizedLoaded, next: NavigationGuardNext): _Awaitable<NavigationGuardReturn>;
}
/**
 * Navigation Guard.
 */
...
//#endregion
export { MatcherPatternPathDynamic_ParamOptions as $, RouteParamsRaw as $t, EXPERIMENTAL_RouteRecord_Group as A, PathParserOptions as An, RouteLocationNormalizedGeneric as At, MatcherPatternQueryParam as B, TypesConfig as Bn, RouteLocationResolvedTyped as Bt, RouterOptions as C, RouteRecordSingleViewWithChildren as Cn, RouteLocationAsRelativeTyped as Ct, EXPERIMENTAL_RouteRecordNormalized_Matchable as D, RouterHistory as Dn, RouteLocationAsStringTypedList as Dt, EXPERIMENTAL_RouteRecordNormalized_Group as E, HistoryState as En, RouteLocationAsStringTyped as Et, EXPERIMENTAL_Router_Base as F, LocationQueryRaw as Fn, RouteLocationNormalizedTyped as Ft, PARAM_PARSER_BOOL as G, RouteRecordNameGeneric as Gt, definePathParamParser as H, RouteLocationTyped as Ht, experimental_createRouter as I, LocationQueryValue as In, RouteLocationNormalizedTypedList as It, MatcherParamsFormatted as J, ParamValue as Jt, START_LOCATION_NORMALIZED as K, RouteRecordRedirectOption as Kt, normalizeRouteRecord as L, LocationQueryValueRaw as Ln, RouteLocationRaw as Lt, EXPERIMENTAL_Router as M, RouteRecord as Mn, RouteLocationNormalizedLoadedGeneric as Mt, EXPERIMENTAL_RouterOptions as N, RouteRecordNormalized as Nn, RouteLocationNormalizedLoadedTyped as Nt, EXPERIMENTAL_RouteRecordRaw as O, RouterMatcher as On, RouteLocationGeneric as Ot, EXPERIMENTAL_RouterOptions_Base as P, LocationQuery as Pn, RouteLocationNormalizedLoadedTypedList as Pt, MatcherPatternPathDynamic as Q, RouteParams as Qt, createFixedResolver as R, parseQuery as Rn, RouteLocationResolved as Rt, Router as S, RouteRecordSingleView as Sn, RouteLocationAsRelativeGeneric as St, EXPERIMENTAL_RouteRecordNormalized as T, _RouteRecordBase as Tn, RouteLocationAsString as Tt, defineQueryParamParser as U, RouteLocationTypedList as Ut, defineParamParser as V, _Awaitable as Vn, RouteLocationResolvedTypedList as Vt, PARAM_PARSER_INT as W, RouteRecordName as Wt, MatcherPatternHash as X, ParamValueZeroOrMore as Xt, MatcherPattern as Y, ParamValueOneOrMore as Yt, MatcherPatternPath as Z, ParamValueZeroOrOne as Zt, routerViewLocationKey as _, RouteQueryAndHash as _n, RouteLocationAsPath as _t, RouterLink as a, MatcherLocation as an, NavigationGuard as at, createMemoryHistory as b, RouteRecordRaw as bn, RouteLocationAsPathTypedList as bt, UseLinkReturn as c, RouteLocationMatched as cn, NavigationGuardReturn as ct, loadRouteLocation as d, RouteLocationPathRaw as dn, ErrorTypes as dt, RouteMap as en, MatcherPatternPathStatic as et, onBeforeRouteLeave as f, RouteMeta as fn, NavigationFailure as ft, routerKey as g, RouteParamsRawGeneric as gn, RouteLocation as gt, routeLocationKey as h, RouteParamsGeneric as hn, isNavigationFailure as ht, RouterViewProps as i, LocationAsRelativeRaw as in, RouterScrollBehavior as it, EXPERIMENTAL_RouteRecord_Matchable as j, _PathParserOptions as jn, RouteLocationNormalizedLoaded as jt, EXPERIMENTAL_RouteRecord_Base as k, createRouterMatcher as kn, RouteLocationNormalized as kt, _RouterLinkI as l, RouteLocationNamedRaw as ln, NavigationGuardWithThis as lt, matchedRouteKey as m, RouteParamValueRaw as mn, NavigationRedirectError as mt, useRouter as n, RouteRecordInfo as nn, MatcherQueryParamsValue as nt, RouterLinkProps as o, MatcherLocationAsPath as on, NavigationGuardNext as ot, onBeforeRouteUpdate as p, RouteParamValue as pn, NavigationFailureType as pt, EmptyParams as q, _RouteRecordProps as qt, RouterView as r, RouteRecordInfoGeneric as rn, ParamParser as rt, UseLinkOptions as s, RouteComponent as sn, NavigationGuardNextCallback as st, useRoute as t, RouteMapGeneric as tn, MatcherQueryParams as tt, useLink as u, RouteLocationOptions as un, NavigationHookAfter as ut, viewDepthKey as v, RouteRecordMultipleViews as vn, RouteLocationAsPathGeneric as vt, createRouter as w, _RouteLocationBase as wn, RouteLocationAsRelativeTypedList as wt, createWebHistory as x, RouteRecordRedirect as xn, RouteLocationAsRelative as xt, createWebHashHistory as y, RouteRecordMultipleViewsWithChildren as yn, RouteLocationAsPathTyped as yt, MatcherPatternQuery as z, stringifyQuery as zn, RouteLocationResolvedGeneric as zt };